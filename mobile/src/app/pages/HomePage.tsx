    ...
    <Pressable onPress={onPress} style={styles.routeCardContainer}>
      <View style={[styles.routeCard, isFavorite && styles.routeCardFavorite]}>
        ...
        <View style={styles.detailsGrid}>
          ...
          <View style={styles.detailItem}>
            <MaterialCommunityIcons name={'terrain' as any} size={14} color="#6b7280" />
  ...
  return (
    <ScrollView style={styles.container} scrollIndicatorInsets={{ right: 1 }}>
      ...
      <View style={styles.mainContent}>
        ...
        <Pressable
          onPress={() =>
            navigation.navigate('RecommendationFlow', { screen: 'RouteConfig' })
          }
          ...
          <View style={styles.section}>
            <View style={styles.sectionHeader}>
              <LinearGradient colors={['#a855f7', '#ec4899']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.sectionIcon}>
                <MaterialCommunityIcons name={'star-four-points' as any} size={20} color="white" />
              </LinearGradient>
              <View>
