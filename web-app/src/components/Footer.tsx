  ...
  return (
    <footer className="bg-primary-900 text-primary-200 py-8 px-6">
      <div className="max-w-5xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        <span className="font-extrabold text-white text-lg"><span aria-hidden="true">🚲</span> CycleLink</span>
        ...
        <p className="text-xs text-primary-400">© {new Date().getFullYear()} CycleLink. CS5224 Group 2.</p>
      </div>
    </footer>
  )
}
